        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal new_complaint"  role="form"  action="sub_complaint.php" method="post">
                    <!-- Dropdown for predefined complaints -->
                    <div class="row form-group">
                        <label class="control-label col-sm-3" for="complaint">Select Complaint:</label>
                        <div class="col-sm-9">
                    ...
                    <!-- Textarea for custom complaint -->
                    <div class="row form-group">
                        <label class="control-label col-sm-3" for="custom_complaint">Custom Complaint:</label>
                        <div class="col-sm-9">
                            <textarea class="form-control" id="custom_complaint" name="custom_complaint" placeholder="Enter custom complaint"></textarea>
                        </div>
                    </div>
            </div>
