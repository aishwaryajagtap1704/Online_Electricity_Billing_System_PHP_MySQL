...
<body>
    ...
    <div class="row mt centered">
        ...
        <div class="row mt centered">
            ...
            <p></p>
            <div class="container">
            <div class="row mt centered"; padding: 20px;">
            <div class="contact-box text-center p-4 border rounded"; color: black;">
            <h1>Contact Us</h1>
            <h>Contact No: <a href="tel:+918355987227" style="color: blue;">+91-83559 87227</a> / <a href="tel:+917039468805" style="color: blue;">+91-70394 68805</a></h><br>
            <h>Email: <a href="mailto:electricityserviceproviders@gmail.com" style="color: blue;">electricityserviceproviders@gmail.com</a></h>
        </div>
    </div>
</div>
